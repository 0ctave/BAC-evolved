...
<button
	onclick={toggleMode}
	class={cn(
		'focus-visible:ring-primary relative inline-flex h-8 w-14 shrink-0 cursor-pointer items-center rounded-full border-2 transition-colors duration-300 ease-in-out focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2',
		/* Track Colors */
...
>
	...
	<span
		class="text-iron-muted/40 absolute right-1.5 flex h-5 w-5 items-center justify-center transition-opacity duration-300"
	...
	<span
		class="text-iron-muted/40 absolute left-1.5 flex h-5 w-5 items-center justify-center transition-opacity duration-300"
		class:opacity-0={currentMode !== 'dark'}
		class:opacity-100={currentMode === 'dark'}
	>
		<svg
	...
	<span
		class={cn(
			'dark:bg-iron-light pointer-events-none relative block flex h-6 w-6 transform items-center justify-center rounded-full border border-black/5 bg-white shadow-md ring-0 transition duration-300 ease-[cubic-bezier(0.175,0.885,0.32,1.275)] dark:border-white/10',
	...
	>
		...
		>
			<svg
				...
				stroke-linecap="round"
				stroke-linejoin="round"
				class="fill-amber-500/20 text-amber-500"
				><circle cx="12" cy="12" r="4" /><path d="M12 2v2" /><path d="M12 20v2" /><path
					d="m4.93 4.93 1.41 1.41"
				/><path d="m17.66 17.66 1.41 1.41" /><path d="M2 12h2" /><path d="M20 12h2" /><path
					d="m6.34 17.66-1.41 1.41"
		...
		>
			<svg
				...
				stroke-linecap="round"
				stroke-linejoin="round"
				class="text-primary fill-primary/20"><path d="M12 3a6 6 0 0 0 9 9 9 9 0 1 1-9-9Z" /></svg
			>
		</span>
	</span>
</button>
